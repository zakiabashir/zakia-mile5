...
(document.getElementById('resumelanguages') as HTMLElement).textContent = languagesText;
(document.getElementById('resumehobbies') as HTMLElement).textContent = hobbiesText;
